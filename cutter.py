...
class clipCutter:
    ...
    def _cut_audio(self):
        ...
        threshold=23173*10**(silent_tresh/10) ##23173 is the standard deviation of a 0 dB tone generated by audancity 
        ...
        if (index_of_rising_edges[0]<index_of_falling_edges[0]):
            ...
            ## line is there to insure that if the vidoe was loud at the beginning it is not incorrectly removed
